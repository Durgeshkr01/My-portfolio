...
export function Education() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-gradient-to-bl from-pink-400/10 to-purple-600/10 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            My academic background and <span className="text-pink-600 font-semibold">educational journey</span> in
            computer science.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <Card
            className={`hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border-0 shadow-lg bg-gradient-to-br from-pink-50 to-purple-50 group ${
            ...
            <CardHeader className="pb-8">
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0">
                  <div className="w-20 h-20 rounded-3xl bg-gradient-to-r from-pink-500 to-purple-500 flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="text-xl font-semibold text-pink-600 mb-6">
                    Centurion University of Technology and Management
                  </CardDescription>
                  <div className="flex flex-col sm:flex-row gap-4 text-sm">
                    <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-lg shadow-sm">
                      <Calendar className="h-4 w-4 text-pink-500" />
                      <span className="font-medium text-slate-700">Expected Graduation: 2028</span>
                    </div>
                    <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-lg shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/80 p-6 rounded-2xl shadow-sm">
                    <p className="text-slate-700 leading-relaxed mb-4">
                      ...
                      <span className="text-pink-600 font-semibold">practical application</span> of theoretical
                      concepts.
                    </p>
                  ...
                  <div className="bg-white/80 p-6 rounded-2xl shadow-sm">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-sm font-bold text-pink-600">Year 1 of 4</span>
                    </div>
                    <div className="w-full bg-slate-200 rounded-full h-3">
                      <div className="bg-gradient-to-r from-pink-500 to-purple-500 h-3 rounded-full w-1/4 shadow-sm"></div>
                    </div>
                  </div>
                </div>
              </div>
