...
import { ArrowDown, Github, Linkedin, Mail, Phone, Sparkles, Code, Rocket } from "lucide-react"
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-cyan-400/10 to-pink-600/10 rounded-full blur-3xl animate-spin"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center space-y-8 animate-in fade-in-0 slide-in-from-bottom-4 duration-1000">
          ...
          <div className="relative w-48 h-48 mx-auto mb-8 group">
            <div
              className="absolute inset-0 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 rounded-full animate-spin"
            ...
            <div className="absolute inset-2 rounded-full overflow-hidden">
              <Image
                ...
                alt="Khushi Singh - Computer Science Engineering Student"
                fill
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="relative">
                <p className="text-xl sm:text-2xl lg:text-3xl text-slate-600 max-w-3xl mx-auto animate-in slide-in-from-right-8 duration-1000 delay-500">
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-pink-600 font-semibold">
            ...
            <p className="text-lg lg:text-xl text-slate-500 max-w-4xl mx-auto leading-relaxed animate-in fade-in-0 duration-1000 delay-700">
              Passionate about building <span className="text-pink-600 font-semibold">modern web applications</span> and
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-in slide-in-from-bottom-8 duration-1000 delay-1000">
            <Button
              size="lg"
              className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white shadow-lg shadow-pink-500/25 hover:shadow-xl hover:shadow-pink-500/40 transition-all duration-300 hover:scale-105 group"
              asChild
            >
              <a href="#projects">
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-2 border-pink-200 text-pink-600 hover:bg-pink-50 hover:border-pink-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group bg-transparent"
              asChild
            >
              <a href="#contact">
          ...
          <div className="flex justify-center space-x-6 animate-in slide-in-from-bottom-8 duration-1000 delay-1200">
            {[
              ...
              { href: "mailto:khushisingh993148@gmail.com", icon: Mail, color: "hover:text-red-600 hover:bg-red-50" },
              { href: "tel:+917070221030", icon: Phone, color: "hover:text-green-600 hover:bg-green-50" },
            ].map((social, index) => (
              <Button
                key={index}
                variant="ghost"
